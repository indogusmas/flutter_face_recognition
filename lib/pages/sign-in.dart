...
import 'package:flutter_face_recognition/locator.dart';
import 'package:flutter_face_recognition/pages/models/user.model.dart';
import 'package:flutter_face_recognition/pages/widgets/app_button.dart';
import 'package:flutter_face_recognition/pages/widgets/single_picture.dart';
...
class SignInState extends State<SignIn> {
  ...
  Future<void> takePicture() async {
    if (_faceDetectorService.faceDetected) {
      ...
      List<Face> face =   await _faceDetectorService.faces;
    print("length face ${face.length}");
  ...
  Future<void> onTap() async {
    ...
    if (_faceDetectorService.faceDetected) {
      ...
      print("user ${user?.modelData.toString()}");
